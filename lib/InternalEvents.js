        ...
        var _loop_1 = function (action) {
            ...
            shortcutsMap[shortcut] = wrap(function (event) {
                ...
                if ((0, utils_1.shouldRejectKeystrokes)())
                    return;
                event.preventDefault();
                if ((_a = action.command) === null || _a === void 0 ? void 0 : _a.perform) {
                    action.command.perform();
                    (_c = (_b = options.callbacks) === null || _b === void 0 ? void 0 : _b.onSelectAction) === null || _c === void 0 ? void 0 : _c.call(_b, action);
                }
                else {
                    query.setCurrentRootAction(action.id);
                    query.toggle();
                    (_e = (_d = options.callbacks) === null || _d === void 0 ? void 0 : _d.onOpen) === null || _e === void 0 ? void 0 : _e.call(_d);
                }
            });
        };
