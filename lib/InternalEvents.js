        ...
        var _loop_1 = function (action) {
            ...
            shortcutsMap[shortcut] = wrap(function (event) {
                ...
                if ((0, utils_1.shouldRejectKeystrokes)())
                    return;
                event.preventDefault();
                if ((_a = action === null || action === void 0 ? void 0 : action.command) === null || _a === void 0 ? void 0 : _a.perform) {
                    (_b = action.command) === null || _b === void 0 ? void 0 : _b.perform();
                    (_d = (_c = options.callbacks) === null || _c === void 0 ? void 0 : _c.onSelectAction) === null || _d === void 0 ? void 0 : _d.call(_c, action);
                }
                else {
                    query.setCurrentRootAction(action.id);
                    query.toggle();
                    (_f = (_e = options.callbacks) === null || _e === void 0 ? void 0 : _e.onOpen) === null || _f === void 0 ? void 0 : _f.call(_e);
                }
            });
        };
