...
function useMatches() {
    ...
    var matches = useInternalMatches(filtered, search, fuse, rootActionId);
...
function useInternalMatches(filtered, search, fuse, rootActionId) {
    ...
    return React.useMemo(function () {
        ...
        matches = searchResults
            .filter(function (_a) {
            var action = _a.item;
            return !(rootActionId == null && action.ignoreInRootSearch);
        })
            .map(function (_a) {
        ...
        return matches;
    }, [throttledFiltered, throttledSearch, fuse, rootActionId]);
}
/**
