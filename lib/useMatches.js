...
function useMatches() {
    ...
    var matches = useInternalMatches(filtered, search, rootActionId);
...
function useInternalMatches(filtered, search, rootActionId) {
    ...
    return React.useMemo(function () {
        ...
        for (var i = 0; i < throttledFiltered.length; i++) {
            ...
            if (!rootActionId && action.ignoreInRootSearch)
                continue;
        ...
        return matches;
    }, [rootActionId, throttledFiltered, throttledSearch]);
}
/**
